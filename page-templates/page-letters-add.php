...
<?php require_once get_template_directory() . '/partials/' . $path . '-nav.php'; ?>
        ...
        <div class="col-lg-6 col-md-8">
            <?php if (has_user_permission($editor)) : ?>
                ...
                <?php else : ?>
                    <h1>Nový dopis</h1>
                <?php endif; ?>
                <?php require_once get_template_directory() . '/partials/letters-add.php'; ?>
            <?php else : ?>
