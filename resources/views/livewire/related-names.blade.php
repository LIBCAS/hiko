        ...
        @foreach ($related_names as $related_name)
            <div wire:key="{{ $loop->index }}" class="p-3 space-y-6 bg-gray-200 shadow">
                <div>
                    ...
                    <x-input wire:model="related_names.{{ $loop->index }}.surname"
                ...
                <div>
                    ...
                    <x-input wire:model="related_names.{{ $loop->index }}.forename"
                ...
                <div>
                    ...
                    <x-input wire:model="related_names.{{ $loop->index }}.general_name_modifier"
