            ...
            <div class="mt-6">
                ...
                <div class="mt-2 p-4 border border-gray-300 rounded text-sm bg-gray-50">
                    <ul class="list-disc list-inside space-y-2">
                        <li><strong>{{ __('hiko.date_year') }}:</strong> {{ $metadata['date_year'] ?? __('hiko.not_available') }}</li>
                        <li><strong>{{ __('hiko.date_month') }}:</strong> {{ $metadata['date_month'] ?? __('hiko.not_available') }}</li>
                        <li><strong>{{ __('hiko.date_day') }}:</strong> {{ $metadata['date_day'] ?? __('hiko.not_available') }}</li>
