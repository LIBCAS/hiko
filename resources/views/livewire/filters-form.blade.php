    ...
    <div class="space-y-2">
        ...
        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            <label class="block text-sm">
                ...
                <x-input wire:model.defer="filters.after" class="w-full px-2 text-sm" type="date" />
            </label>
            <label class="block text-sm">
                <span class="block text-black">{{ __('hiko.to') }}</span>
                <x-input wire:model.defer="filters.before" class="w-full px-2 text-sm" type="date" />
            </label>
        </div>
    </div>
    ...
    <div class="space-y-2">
        ...
        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            <label class="block text-sm">
                ...
                <x-input wire:model.defer="filters.id" class="w-full px-2 text-sm" type="text" />
            </label>
            <label class="block text-sm">
                <span class="block text-black">{{ __('hiko.signature') }}</span>
                <x-input wire:model.defer="filters.signature" class="w-full px-2 text-sm" type="text" />
            </label>
        </div>
    </div>
    ...
    <div class="space-y-2">
        ...
        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            <label class="block text-sm">
                ...
                <x-input wire:model.defer="filters.author" class="w-full px-2 text-sm" type="text" />
            </label>
            <label class="block text-sm">
                <span class="block text-black">{{ __('hiko.recipient') }}</span>
                <x-input wire:model.defer="filters.recipient" class="w-full px-2 text-sm" type="text" />
            </label>
        </div>
    </div>
    ...
    <div class="space-y-2">
        ...
        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            <label class="block text-sm">
                ...
                <x-input wire:model.defer="filters.origin" class="w-full px-2 text-sm" type="text" />
            </label>
            <label class="block text-sm">
                <span class="block text-black">{{ __('hiko.destination') }}</span>
                <x-input wire:model.defer="filters.destination" class="w-full px-2 text-sm" type="text" />
            </label>
        </div>
    </div>
    ...
    <div class="space-y-2">
        ...
        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            <label class="block text-sm">
                ...
                <x-input wire:model.defer="filters.repository" class="w-full px-2 text-sm" type="text" />
            </label>
            <label class="block text-sm">
                <span class="block text-black">{{ __('hiko.archive') }}</span>
                <x-input wire:model.defer="filters.archive" class="w-full px-2 text-sm" type="text" />
            </label>
            <label class="block text-sm">
                <span class="block text-black">{{ __('hiko.collection') }}</span>
                <x-input wire:model.defer="filters.collection" class="w-full px-2 text-sm" type="text" />
            </label>
        </div>
    </div>
    ...
    <div class="space-y-2">
        ...
        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            <label class="block text-sm">
                ...
                <x-input wire:model.defer="filters.keyword" class="w-full px-2 text-sm" type="text" />
            </label>
            <label class="block text-sm">
                <span class="block text-black">{{ __('hiko.mentioned') }}</span>
                <x-input wire:model.defer="filters.mentioned" class="w-full px-2 text-sm" type="text" />
            </label>
            <label class="block text-sm">
                <span class="block text-black">{{ __('hiko.full_text') }}</span>
                <x-input wire:model.defer="filters.fulltext" class="w-full px-2 text-sm" type="text" />
            </label>
            <label class="block text-sm">
                <span class="block text-black">{{ __('hiko.abstract') }}</span>
                <x-input wire:model.defer="filters.abstract" class="w-full px-2 text-sm" type="text" />
            </label>
        </div>
    </div>
    ...
    <div class="space-y-2">
        ...
        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            <label class="block text-sm">
                ...
                <x-input wire:model.defer="filters.languages" class="w-full px-2 text-sm" type="text" />
            </label>
            <label class="block text-sm">
                <span class="block text-black">{{ __('hiko.note') }}</span>
                <x-input wire:model.defer="filters.note" class="w-full px-2 text-sm" type="text" />
            </label>
            <label class="block text-sm">
                <span class="block text-black">
                    {{ __('hiko.media') }}
                </span>
                <x-select wire:model.defer="filters.media" class="w-full px-2 text-sm">
                    <option value="">
                        ---
                    </option>
                    <option value="1">
            ...
            <label class="block text-sm">
                ...
                <x-select wire:model.defer="filters.status" class="w-full px-2 text-sm">
                    <option value="">
                        ---
                    </option>
            ...
            <label class="block text-sm">
                ...
                <x-select wire:model.defer="filters.approval" class="w-full px-2 text-sm">
                    <option value="">
                        ---
                    </option>
            ...
            <label class="block text-sm">
                ...
                <x-input wire:model.defer="filters.editor" class="w-full px-2 text-sm" type="text" />
            </label>
            ...
            <label class="block text-sm">
                ...
                <x-select wire:model.defer="filters.editor" class="w-full px-2 text-sm">
                    <option value="">
                        {{ __('hiko.no') }}
                    </option>
                    <option value='my'>
