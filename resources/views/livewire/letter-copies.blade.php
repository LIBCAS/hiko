        ...
        @foreach ($copies as $item)
            <div class="p-3 space-y-6 bg-gray-200 shadow">
                <div>
                    ...
                    <x-select wire:model.defer="copies.{{ $loop->index }}.ms_manifestation"
                        name="copies[{{ $loop->index }}][ms_manifestation]" class="block w-full mt-1"
                ...
                <div>
                    ...
                    <x-select wire:model.defer="copies.{{ $loop->index }}.copy" id="type_{{ $loop->index }}"
