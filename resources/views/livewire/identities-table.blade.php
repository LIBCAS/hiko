<div>
    <x-filter-form>
        <div class="grid w-full flex-1 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <label>
                <span class="block text-sm">{{ __('hiko.name') }}</span>
                <x-input wire:model.live.debounce.1000ms="filters.name" data-identity-filter="name" class="block w-full px-2 text-sm" type="text" />
            </label>
            <label>
            ...
            <label>
                ...
                <x-input wire:model.live.debounce.1000ms="filters.profession" data-identity-filter="profession" class="block w-full px-2 text-sm" type="text" />
            </label>
            <label>
                <span class="block text-sm">{{ __('hiko.religion') }}</span>
                <x-input wire:model.live.debounce.1000ms="filters.religion" data-identity-filter="religion" class="block w-full px-2 text-sm" type="text" />
            </label>
            <label>
            ...
            <label>
                ...
                <x-input wire:model.live.debounce.1000ms="filters.admin_notes" data-identity-filter="admin_notes" class="block w-full px-2 text-sm" type="text" />
            </label>
            {{-- Source Filter --}}
            <label>
                <span class="block text-sm">{{ __('hiko.source') }}</span>
                <x-select wire:model.live.debounce.1000ms="filters.source" data-identity-filter="source" class="w-full px-2 text-sm">
