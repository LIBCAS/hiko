...
Route::middleware([InitializeTenancyByDomain::class],'web')->group(function () {
    ...
    Route::prefix('inter-tenant-transfers')
        ...
        ->group(function () {
            ...
            Route::get('/{transfer}/dependencies/{type}/{sourceId}/copy-preview', [InterTenantLetterTransferController::class, 'copyDependencyPreview'])
    ...
    Route::prefix('dev')->group(function () {
        ...
        // Route::get('export-global-identity-strict-merge-candidates', [DevToolsController::class, 'exportGlobalIdentityStrictMergeCandidates'])
        //     ->name('dev.export-global-identity-strict-merge-candidates')
        //     ->middleware(['auth', 'can:debug']);
    });
