...
if (array_key_exists('new_post', $_POST) && $_POST['new_post'] == 1) {
    ...
    $post_data = [
        ...
        'origin_inferred' => $_POST['origin_inferred'] == 'on' ? 1 : 0,
        'origin_uncertain' => $_POST['origin_uncertain'] == 'on' ? 1 : 0,
        'dest' => test_input($_POST['dest']),
        'dest_marked' => test_input($_POST['dest_marked']),
        'dest_uncertain' => $_POST['dest_uncertain'] == 'on' ? 1 : 0,
        'dest_inferred' => $_POST['dest_inferred'] == 'on' ? 1 : 0,
        'languages' => $languages,
        'keywords' => $keywords,
