...
function export_letters()
{
    ...
    while ($pod->fetch()) {
        ...
        $row = [
            ...
            (string) ($pod->field('range_year') == '0') ? '' : $pod->field('range_year'),
            (string) ($pod->field('range_month') == '0') ? '' : $pod->field('range_month'),
            (string) ($pod->field('range_date') == '0') ? '' : $pod->field('range_date'),
